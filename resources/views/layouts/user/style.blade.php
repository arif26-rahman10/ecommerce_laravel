...
<link rel="stylesheet" href="{{('assets/templates/user/css/ion.rangeSlider.css')}}">
<link rel="stylesheet" href="{{('assets/templates/user/css/ion.rangesSlider.skinFlat.css')}}">
